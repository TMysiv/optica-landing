...
const schemaOrg = {
  ...
  "@type": "LocalBusiness",
  "name": "Укртелеком",
  "url": "https://твійсайт.ua",
  "logo": "https://твійсайт.ua/images/logo.svg",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://твійсайт.ua/" />

        {/* Open Graph (для соцмереж) */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://твійсайт.ua/" />
        <meta property="og:title" content="Підключити інтернет до 1 Гбіт/с | Укртелеком GPON" />
        <meta property="og:description" content="Оптичний інтернет GPON від Укртелеком — до 1 Гбіт/с, енергонезалежний до 96 годин. Тариф від 150 грн/міс." />
        <meta property="og:image" content="https://твійсайт.ua/images/desktop-banner.webp" />
        <meta property="og:locale" content="uk_UA" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Підключити інтернет до 1 Гбіт/с | Укртелеком" />
        <meta name="twitter:description" content="Оптичний інтернет GPON від Укртелеком — до 1 Гбіт/с, від 150 грн/міс." />
        <meta name="twitter:image" content="https://твійсайт.ua/images/desktop-banner.webp" />
      ...
      <Box className="overflow-hidden">
        ...
        <Equipments/>
        <h2 className="form-t max-w-[440px] text-white text-center text-[40px] font-bold leading-[117.5%] mt-[133px] mb-[51px] mx-auto">
